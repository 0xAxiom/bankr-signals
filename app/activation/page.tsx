...
export const metadata: Metadata = {
  title: "Provider Activation Dashboard - Bankr Signals",
  description: "Real-time view of provider registration and signal activity. Identify inactive agents and track onboarding success.",
};
        ...
        <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg p-4 mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            ...
            <div>
              ...
              <span className="ml-2 font-mono font-bold">
                {Math.max(...realProviders.map(p => p.win_rate)) || 0}%
              </span>
            </div>
            <div>
