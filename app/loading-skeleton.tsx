export function CardSkeleton() {
  return (
    <div className="border-l-2 border-[#2a2a2a] border-r border-t border-b rounded-lg p-3 sm:p-4 bg-[#1a1a1a] animate-pulse">
      {/* Header */}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-3">
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i}>
            <div className="w-12 h-3 bg-[#2a2a2a] rounded mb-1"></div>
