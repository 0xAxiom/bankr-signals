    ...
    <nav className="border-b border-[#2a2a2a] px-4 sm:px-6 py-3 sticky top-0 bg-[#0a0a0a] z-50">
      <div className="flex items-center justify-between">
        ...
        <div className="hidden sm:flex items-center gap-6 text-xs">
          ...
          <a href="/copy-trading" className="text-[#737373] hover:text-[#e5e5e5] transition-colors">
            Copy Trading
          </a>
        ...
        <div className="flex sm:hidden items-center gap-4 text-xs">
          ...
          <a href="/register/simple" className="text-[rgba(34,197,94,0.8)] hover:text-[rgba(34,197,94,1)] transition-colors font-medium">
            Register
          </a>
          <MobileMenu />
        </div>
